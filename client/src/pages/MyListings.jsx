  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-8000">My Listings</h1>
      ...
      {/* Balance Section  */}
      <div className="flex flex-col sm:flex-row justify-between gap-4 lx:gap-20 p-6 mb-10 bg-white rounded-xl border border-gray-200">
        {[
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                    <span className="text-2xl font-bold text-gray-800">
                      {currency}
                      {listing.price.toFixed(1).toLocaleString()}
                    </span>
