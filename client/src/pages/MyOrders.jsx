  ...
  if (!orders.length) {
    return (
      <div className="px-4 md:px-16 lg:px-24 xl:px-32">
        <div className="max-w-2xl mx-auto mt-14 bg-white rounded-lg border border-gray-200 p-8 text-center">
          <h3 className="text-lg font-semibold">No Orders Yet</h3>
          <p className="text-sm text-gray-500 mt-2">
            You haven't purchase any listings yet.
          </p>
        </div>
      </div>
    );
                  ...
                  <div className="flex items-center justify-between gap-4">
                    <div className="">
                      ...
                      <div className="flex gap-2 mt-2">
                        {listing.verified && (
                          <span className="flex items-center text-sm bg-indigo-50 text-indigo-600 px-2 py-1 rounded-md">
                            <CheckCircle2 className="w-3 h-3 mr-1" />
                            Verified
                          </span>
                        )}
                        {listing.monetized && (
                          <span className="flex items-center text-sm bg-green-50 text-green-600 px-2 py-1 rounded-md">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="px-2 py-1 text-sm bg-white border border-gray-200 rounded hover:shadow"
