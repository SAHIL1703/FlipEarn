...
const ChatBox = () => {
  ...
  //Create the function to fetch the chatData
  ...
  //if the isopen is false and the listing is false if any one is false then return null
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-100 flex items-center justify-center sm:p-4">
      <div className="bg-white sm:rounded-lg shadow-2xl w-full max-w-2xl h-screen sm:h-[600px] flex flex-col">
        ...
        {/* Messages  */}
        <div className="flex-1 overflow-y-auto p-4 space-y-5 bg-gray-100">
          {isLoading ? (
